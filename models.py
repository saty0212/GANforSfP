...
class BaseGAN():
    ...
    def fit(self,
        ...
        # train
        # print(X_tens.shape, y_tens.shape, batch_size, n_iters, y_train)
...
class WGANGP(BaseGAN):
    ...
    def _calc_gradient_penalty(self, real_data, fake_data, y=None):
        ...
        # print(real_data.data.shape, fake_data.data.shape, self.batch_size, epsilon.shape)
        # exit(0)
