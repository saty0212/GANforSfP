...
def append_record(record):
    with open('./results/individual_results_rus.txt', 'w') as f:
        f.write(str(record))
        f.write(os.linesep)
...
for name in os.listdir(path) :
  if name.endswith(".csv") :
    for i in range(10) :
      ...
      train = pd.read_csv(path + "train/train_"+str(i+1)+"_"+name, header=None)
      ...
      rus_x, rus_y = random_under_sampler.fit_resample(train_x, train_y)
      ...
      results[name][i+1]["rus"]['knn'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["rus"]['rf'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["rus"]['dt'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["rus"]['nb'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["rus"]['lr'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
...
with open('./results/averaged_results_rus.txt', 'w') as f:
