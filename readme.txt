First of all mount the drive if it's not mounted on this notebook file

now, you need to go to the directory wgangp.
run the below code to change the directory to wgangp
        cd drive/MyDrive/wgangp

We have created seven different script files, each belonging to an individual technique to handle the imbalance in the data.
