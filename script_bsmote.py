...
def append_record(record):
    with open('./results/individual_results_bsmote.txt', 'w') as f:
        f.write(str(record))
        f.write(os.linesep)
...
for name in os.listdir(path) :
  if name.endswith(".csv") :
    for i in range(10) :
      ...
      results[name][i+1]["bsmote"]['knn'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["bsmote"]['rf'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["bsmote"]['dt'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["bsmote"]['nb'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
      ...
      fn = disp.confusion_matrix[1][0]
      tn = disp.confusion_matrix[0][0]
      results[name][i+1]["bsmote"]['lr'] = [score, precision, recall, f1, auc, tp, fp, tn, fn]
...
with open('./results/averaged_results_bsmote.txt', 'w') as f:
